...
class Player
  ...
  def initialize
    ...
    @score = 0
    @history = History.new
    @weights = { 'rock' => 10, 'paper' => 10, 'scissors' => 10, 'spock' => 10, 'lizard '=> 10 }
  end
end
...
class RPSGame
  ...
  def update_computer_weights
     value = 0
     determine_round_winner == computer.name ? value += 1 : value -= 1
     computer.weights[computer.move] += value
  end
